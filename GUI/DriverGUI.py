...
class main_frame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.score_text_statictext = wx.StaticText( self.score_panel, wx.ID_ANY, u"请先驾驶一段时间", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		bSizer23.Add( self.score_text_statictext, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		...
		self.angry_detect_on_checkbox = wx.CheckBox( self.config_panel, wx.ID_ANY, u"开启", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.angry_detect_on_checkbox.SetValue(True)
		self.angry_detect_on_checkbox.SetFont( wx.Font( 16, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "微软雅黑" ) )

		bSizer27.Add( self.angry_detect_on_checkbox, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		...
		self.angry_ratiobutton2 = wx.RadioButton( self.config_panel, wx.ID_ANY, u"相声", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.angry_ratiobutton3 = wx.RadioButton( self.config_panel, wx.ID_ANY, u"音乐", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.angry_ratiobutton3.SetFont( wx.Font( 16, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "微软雅黑" ) )

		bSizer27.Add( self.angry_ratiobutton3, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		...
		self.remind_interval_ratiobtn1 = wx.RadioButton( self.config_panel, wx.ID_ANY, u"5分钟", wx.DefaultPosition, wx.DefaultSize, wx.RB_GROUP )
		self.remind_interval_ratiobtn1.SetFont( wx.Font( 16, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "微软雅黑" ) )

		bSizer29.Add( self.remind_interval_ratiobtn1, 0, wx.ALL, 5 )

		self.remind_interval_ratiobtn2 = wx.RadioButton( self.config_panel, wx.ID_ANY, u"10分钟", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.remind_interval_ratiobtn2.SetValue( True )
		self.remind_interval_ratiobtn2.SetFont( wx.Font( 16, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "微软雅黑" ) )

		bSizer29.Add( self.remind_interval_ratiobtn2, 0, wx.ALL, 5 )

		self.remind_interval_ratiobtn3 = wx.RadioButton( self.config_panel, wx.ID_ANY, u"15分钟", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.remind_interval_ratiobtn3.SetFont( wx.Font( 16, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "微软雅黑" ) )

		bSizer29.Add( self.remind_interval_ratiobtn3, 0, wx.ALL, 5 )
